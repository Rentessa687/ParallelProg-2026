...
Начиная с n = 500 эта величина стабилизируется в диапазоне 7.3×10⁻⁷ – 8.1×10⁻⁷ мс, что экспериментально подтверждает квадратичную сложность одной итерации. Отклонение на малых n (100, 250) объясняется overhead'ом самого измерения времени — накладные расходы на запуск таймера сопоставимы с временем полезной работы при малом объёме вычислений.
